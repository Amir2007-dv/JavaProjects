...
Statement ps;
    /**
     * Creates new form borrarProveedor
     */
...
try{
String queryInsertar="DROP proveedores WHERE id_prov="+id+"";
...
JOptionPane.showMessageDialog(null, "Error al borrar datos"+e.getMessage());
}
}
